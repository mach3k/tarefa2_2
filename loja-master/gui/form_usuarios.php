...
<html lang="pt-br">
	...
	<body>
		<div class="container">
			...
			<form method="post" action="<?php echo URL_BASE; ?>admin/usuarios.php?acao=gravar">
				<?php
				...
				<div class="form-group">
					<button type="submit">Gravar</button><button type="button" onclick="document.location='<?=URL_BASE;?>admin/usuarios.php';">Voltar</button>
				</div>
			</form>
		</div>
	</body>
